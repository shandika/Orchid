...
class Mailer {
    protected $_ci;
    protected $email_pengirim = 'admin@rumah-halal.com'; // Isikan dengan email pengirim
    protected $nama_pengirim = 'Royal Orchid Syariah'; // Isikan dengan nama pengirim
    protected $password = 'admin321'; // Isikan dengan password email pengirim
    ...
    public function send($data){
        ...
        $mail->AddEmbeddedImage('assets/images/logo3.png', 'logo_orchid', 'logo3.png'); // Aktifkan jika ingin menampilkan gambar dalam email
