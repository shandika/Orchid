                            ...
                            <tbody>
                                ...
                                ?>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <form action="<?= base_url('pm/terima_barang_button') ?>" method="POST">
                                                <input type="hidden" name="ID_po" value="<?= $baris->ID_po; ?>">
                                                <button type="submit" class="btn btn-success"><i class="fa fa-get-pocket"></i></button>
                                            </form>
                                        </td>
                                        <td>
                                            <form action="<?= base_url('pm/return_barang_button') ?>" method="POST">
                                                <input type="hidden" name="ID_po" value="<?= $baris->ID_po; ?>">
                                                <button class="btn btn-danger"><i class="fa fa-undo"></i></button>
                                            </form>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
